...
print(proba[1])
proba = np.log(proba)
save_file = training_path[:-4]+'_spfbias.pkl' 
...
'''
prediction = predict(cclf, vectorizer, eval_texts)
acc = accuracy_score(eval_y, prediction)
print(f'Accuracy score: {acc}')

eval_path = 'toxic_language/ood_data/facebook_adv.csv'  
# Read in diagnose data
eval_data = read_csv(eval_path)
eval_texts = eval_data['tweet']
eval_y = eval_data['ND_label']
...
prediction = predict(cclf, vectorizer, eval_texts)
acc = accuracy_score(eval_y, prediction)
print(f'Accuracy score facebook: {acc}')

eval_path = 'toxic_language/ood_data/identity_bias.csv'  
# Read in diagnose data
eval_data = read_csv(eval_path)
eval_texts = eval_data['tweet']
eval_y = eval_data['ND_label']
...
prediction = predict(cclf, vectorizer, eval_texts)
acc = accuracy_score(eval_y, prediction)
print(f'Accuracy score identity: {acc}')

eval_path = 'toxic_language/ood_data/ND_TwitterHate-FountaDavidson_yesDial_agg.csv'  
# Read in diagnose data
eval_data = read_csv(eval_path)
eval_texts = eval_data['tweet']
eval_y = eval_data['ND_label']
...
prediction = predict(cclf, vectorizer, eval_texts)
acc = accuracy_score(eval_y, prediction)
print(f'Accuracy score dialect priming: {acc}')

eval_path = 'toxic_language/ood_data/ND_TwitterHate-FountaDavidson_yesRace_agg.csv'  
# Read in diagnose data
eval_data = read_csv(eval_path)
eval_texts = eval_data['tweet']
eval_y = eval_data['ND_label']
...
prediction = predict(cclf, vectorizer, eval_texts)
acc = accuracy_score(eval_y, prediction)
print(f'Accuracy score race priming: {acc}')
'''
